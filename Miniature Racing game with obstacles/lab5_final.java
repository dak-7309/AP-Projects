...
class Application{
    ...
    public void app_start() throws NotGreaterThanTen, NotNewLine, SnakeBiteException,CricketBiteException,VultureBiteException,WhiteException,TrampolineBiteException,GameWinnerException{
        int n=0;
        boolean BEG=false;
        while(!BEG){
...
class MainGame{
    Scanner scan=new Scanner(System.in);
    public void create_player(Track T, ArrayList<Tile> Game_Map, int n) throws NotNewLine, SnakeBiteException,CricketBiteException,VultureBiteException,WhiteException,TrampolineBiteException, GameWinnerException{
        String name="";
        boolean BEG=false;
        while(!BEG){
            try{
    ...
    public void gameplay(Player P,Track T, ArrayList<Tile> Game_Map, int n) throws NotNewLine, SnakeBiteException,CricketBiteException,VultureBiteException,WhiteException,TrampolineBiteException,GameWinnerException{
...
public class lab5_final{
    public static void main(String[] args) throws NotGreaterThanTen, NotNewLine, SnakeBiteException,CricketBiteException,VultureBiteException,WhiteException,TrampolineBiteException,GameWinnerException{
